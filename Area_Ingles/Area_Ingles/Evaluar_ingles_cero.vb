Public Class Evaluar_ingles_cero
    Dim tiempo As Integer
    Private Property puntaje As String
    Private Sub Evaluar_ingles_cero_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub btn_calificar_ingles_cero_Click(sender As Object, e As EventArgs) Handles btn_calificar_ingles_cero.Click
        puntaje = 0
        ...
        Else
            ...
            Labe_calificacion.Visible = True
            Labe_calificacion.Text = puntaje

        End If
        If puntaje > 6 Then
            MsgBox("usted a pasado este nivel")
            Me.Close()
        End If
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If s < 10 Then
            Labe_time1.Visible = True
            Labe_time1.Text = m & ":" & s
        Else
            Labe_time2.Visible = True
            Labe_time2.Text = m & ":" & s
        End If

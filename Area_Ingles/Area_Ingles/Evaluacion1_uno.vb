Public Class Evaluacion1_uno
    Private Property puntaje As String
    Public buenas, malas, pregunta, m, s As Integer

    Private Sub Label_time2_Click(sender As Object, e As EventArgs) Handles Label_time2.Click
    ...
    Private Sub Evaluacion1_uno_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub Button_iniciar_evaluacion_Click(sender As Object, e As EventArgs) Handles Button_iniciar_evaluacion.Click
    ...
    Private Sub Button_calificar_Click(sender As Object, e As EventArgs) Handles Button_calificar.Click
        puntaje = 0
